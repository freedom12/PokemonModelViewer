...
export const createFireMaterial: MaterialCreator = (
  ...
  // 获取各层的参数
  const baseColorLayer1 = data.getColorParam('BaseColorLayer1', new THREE.Vector4(5.0, 0.075, 0.0295, 1.0))
  const baseColorLayer2 = data.getColorParam('BaseColorLayer2', new THREE.Vector4(4.0, 0.8, 0.18, 1.0))

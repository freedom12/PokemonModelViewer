 ...
 * SSS 材质
 *
 * SSS (Subsurface Scattering) 是次表面散射材质，支持完整的物理渲染特性。
 * 使用标准的纹理贴图和参数，适用于需要次表面散射效果的模型部件。
 *
 * @module materials/SSSMaterial
 */
 ...
 * @returns THREE.MeshStandardMaterial SSS 材质
 */
export const createSSSMaterial: MaterialCreator = (
  data: MaterialData,
  basePath: string,
  ...
  material.userData.sssParams = sssParams;
